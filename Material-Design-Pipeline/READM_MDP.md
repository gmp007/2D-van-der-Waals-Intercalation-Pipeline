...
3. Add VASP POTCAR files:
   - Place VASP POTCAR files in "VDW_workflow_files\POTCAR_files\PBE_52" using the naming convention "POTCAR_<atom type>". Ensure inclusion of POTCAR files for all investigated atoms.
